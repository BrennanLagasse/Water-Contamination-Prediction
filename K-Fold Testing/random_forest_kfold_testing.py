...
print(f"\nNumber of features: {X_array.shape[1]}")
...
# Save results
results_df.to_csv('rf_kfold_results.csv', index=False)
print(f"\n{'='*70}")
print("Results saved to 'rf_kfold_results.csv'")
print(f"{'='*70}")