...
wqp = wqp[["MonitoringLocationIdentifier", "CharacteristicName", "ResultSampleFractionText", "ActivityLocation/LatitudeMeasure", "ActivityLocation/LongitudeMeasure", "ResultMeasureValue", "ResultMeasure/MeasureUnitCode", "DetectionQuantitationLimitMeasure/MeasureValue", "DetectionQuantitationLimitMeasure/MeasureUnitCode"]].merge(
...
outlier_mask = ground_truth <= 1000
wqp = wqp[outlier_mask].reset_index(drop=True)
ground_truth = ground_truth[outlier_mask].reset_index(drop=True)
